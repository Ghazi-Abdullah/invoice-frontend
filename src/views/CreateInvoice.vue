                ...
                <div class="space-y-6">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div v-if="errors.client_id" class="mt-2 text-sm text-red-600 flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <!-- Client Preview -->
                      <div v-if="selectedClient" class="mt-4 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                        <div class="flex items-start">
                          <div class="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center ml-3">
                          ...
                          <div class="flex-1">
                            ...
                            <div class="flex items-center gap-2 mt-2">
                              ...
                              <span v-if="selectedClient.company_name" class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded flex items-center gap-1">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div class="mt-2">
                        <span v-if="daysUntilDue > 0" class="text-sm text-green-600 flex items-center gap-1">
                          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                          </svg>
                          {{ daysUntilDue }} يوم حتى الاستحقاق
                        </span>
                        <span v-else-if="daysUntilDue === 0" class="text-sm text-yellow-600 flex items-center gap-1">
                          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                          </svg>
                          مستحق اليوم
                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                      <tr>
                        <th class="px-4 py-3 text-right text-sm font-semibold text-gray-700 uppercase tracking-wider">الوصف</th>
                        <th class="px-4 py-3 text-center text-sm font-semibold text-gray-700 uppercase tracking-wider">الكمية</th>
                        <th class="px-4 py-3 text-right text-sm font-semibold text-gray-700 uppercase tracking-wider">السعر</th>
                        <th class="px-4 py-3 text-right text-sm font-semibold text-gray-700 uppercase tracking-wider">المجموع</th>
                        <th class="px-4 py-3 text-center text-sm font-semibold text-gray-700 uppercase tracking-wider">الإجراءات</th>
                      </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                      <tr v-for="(item, index) in invoiceData.items" :key="index" class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-4 py-4">
                          <input
                          ...
                          <div class="flex items-center justify-center">
                            <button
                              ...
                              :class="[
                                ...
                                item.quantity <= 1 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-gray-50 hover:bg-gray-100 text-gray-600'
                              ]"
                            >
                              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-xl">
                  ...
                  <div class="flex flex-wrap gap-2">
                    ...
                    >
                      ...
                      <span class="text-xs text-gray-500">{{ formatCurrency(quickItem.unit_price) }}</span>
                    </button>
                  </div>
                </div>
            ...
            >
              ...
              <div class="p-6">
                <div class="space-y-8">
                  <!-- Invoice Status -->
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-4">حالة الفاتورة *</label>
                  ...
                  <!-- Payment Method -->
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-4">طريقة الدفع</label>
                  ...
                  <div class="border-t border-gray-200 pt-6">
                    ...
                    <div v-if="invoiceData.enable_stripe_checkout" class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6">
                      <div class="flex items-start">
                        <div class="w-12 h-12 bg-white border border-blue-200 rounded-xl flex items-center justify-center ml-4">
                          <svg class="w-8 h-8 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 1.227 0 1.998.561 2.382 1.426h2.12c-.473-2.103-1.966-3.518-4.502-3.518-2.536 0-4.352 1.601-4.352 3.95 0 2.506 1.956 3.518 4.352 4.313 2.386.795 3.165 1.426 3.165 2.313 0 .976-.903 1.496-2.208 1.496-1.306 0-2.456-.62-2.97-1.776h-2.21c.514 2.103 2.11 3.518 5.18 3.518 3.06 0 5.16-1.601 5.16-4.103 0-2.7-2.148-3.617-4.534-4.412z"/>
                          </svg>
                        </div>
                        <div class="flex-1">
                          <h5 class="font-bold text-gray-900 text-lg">Stripe Checkout مفعل</h5>
                          <p class="text-gray-700 mt-2">سيتم إنشاء رابط دفع آمن يمكن مشاركته مع العميل.</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <transition name="fade">
            ...
            >
              ...
              <div class="p-6">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-2xl p-6">
                  <div class="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
                    <div>
                      ...
                      <div class="flex items-center gap-2 mt-2">
                        <span :class="getStatusBadgeClass(invoiceData.status)" class="px-3 py-1.5 rounded-full text-xs font-semibold inline-flex items-center gap-1">
                          <span :class="getStatusDotClass(invoiceData.status)" class="w-2 h-2 rounded-full"></span>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div class="space-y-2">
                        <div v-if="selectedClient" class="bg-white p-4 rounded-xl border border-gray-200">
                          <div class="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <div class="text-sm text-gray-600">{{ selectedClient.phone || 'لا يوجد هاتف' }}</div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div class="space-y-3">
                        ...
                        <div v-if="invoiceData.payment_date" class="flex justify-between items-center p-3 bg-white rounded-xl border border-gray-200">
                          <span class="text-gray-600">تاريخ الدفع:</span>
                          <span class="font-medium text-green-600">{{ formatDate(invoiceData.payment_date) }}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mt-8">
                    <div class="space-y-4">
                      ...
                      <div class="flex justify-between items-center p-4 bg-white rounded-xl border border-gray-200">
                        ...
                        <span class="text-xl font-bold text-blue-600">{{ formatCurrency(invoiceData.total || 0) }}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <!-- Final Actions -->
                <div class="flex flex-col sm:flex-row justify-between gap-4 pt-6 mt-6 border-t border-gray-200">
                  <button
                    @click="prevStep"
          ...
          <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sticky top-6">
            ...
            <div class="space-y-4">
              <div class="text-center mb-4">
                <span :class="getStatusBadgeClass(invoiceData.status)" class="px-4 py-2 rounded-full text-sm font-semibold inline-flex items-center gap-2">
                  <span :class="getStatusDotClass(invoiceData.status)" class="w-2 h-2 rounded-full"></span>
                  {{ getStatusText(invoiceData.status) }}
                </span>
              </div>
              ...
              <div class="space-y-3">
                ...
                <div class="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl">
              ...
              <div class="grid grid-cols-2 gap-3 mt-6">
                ...
                <div class="text-center p-3 bg-green-50 rounded-xl border border-green-100">
                  ...
                  <div class="text-lg font-bold text-green-700">{{ formatCurrency(averagePrice) }}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="space-y-3">
              <div class="flex items-start gap-2">
                ...
                <p class="text-sm text-gray-600">استخدم Stripe Checkout لتلقي المدفوعات أونلاين بسهولة.</p>
              </div>
              <div class="flex items-start gap-2">
              ...
              <div class="flex items-start gap-2">
                ...
                <p class="text-sm text-gray-600">تأكد من اختيار العميل وتاريخ الاستحقاق قبل المتابعة.</p>
              </div>
            </div>
          </div>
        </div>
